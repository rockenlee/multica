...
function useIssueCounts(
  ...
  return useMemo(() => {
    ...
    if (serverFacets) {
      ...
      return { status, priority, assignee, creator, noAssignee, project, noProject, label, property, source };
    }
      ...
      <div className="flex h-full w-max min-w-full items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1">
          ...
          <IssueDisplayControls
            ...
            onToggleIssueSourceFilter={onToggleIssueSourceFilter}
            onClearIssueSourceFilters={onClearIssueSourceFilters}
